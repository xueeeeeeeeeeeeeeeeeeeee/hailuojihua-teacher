<template>
    <a-drawer title="聊天室详情" placement="right" :closable="false" v-model:open="chatVisible"
        width="50%">
        <hailuo></hailuo>
    </a-drawer>
    <a-drawer title="xxx游戏详情" placement="right" :closable="false" v-model:open="gameVisible"
        width="50%">
